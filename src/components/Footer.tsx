        ...
        <div className="pt-20 pb-16 grid grid-cols-1 lg:grid-cols-[1.6fr_1fr_1fr_1fr] gap-14 lg:gap-8 border-b border-[rgba(240,241,245,0.1)]">
          ...
          <div className="flex flex-col gap-8">
            <div>
              ...
              <p className="font-serif italic text-[clamp(15px,1.3vw,17px)] text-[#B8BDCE] leading-relaxed max-w-[30ch]">
            ...
            <div>
              ...
              <a
                ...
                className="group inline-flex items-center gap-3 font-mono text-[12px] tracking-[0.22em] uppercase hover:text-[#C9A24A] transition-colors duration-300"
                style={{ color: "#EDEBE3" }}
              >
                <span
                  className="w-7 h-7 rounded-full border border-[rgba(240,241,245,0.1)] group-hover:border-[#C9A24A] flex items-center justify-center transition-colors duration-300"
                  style={{ background: "rgba(12,14,20,0.8)" }}
                >
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor" className="text-[#4A4F62] group-hover:text-[#C9A24A] transition-colors duration-300">
          ...
          {/* Practices */}
          <div>
            <p className="font-mono text-[11px] tracking-[0.5em] uppercase text-[#C9A24A] opacity-50 mb-7">Practices</p>
              <ul className="flex flex-col gap-4">
                {[
                  ...
                  <li key={l.href}>
                    <Link
                      href={l.href}
                      className="font-mono text-[12px] tracking-[0.18em] uppercase hover:text-[#C9A24A] transition-colors duration-300"
                      style={{ color: "#EDEBE3" }}
                    >
                      {l.label}
                    </Link>
            ...
            {/* Index */}
            <div>
              <p className="font-mono text-[11px] tracking-[0.5em] uppercase text-[#C9A24A] opacity-50 mb-7">Index</p>
              <ul className="flex flex-col gap-4">
                {[
            ...
            {/* Contact */}
            <div>
              <p className="font-mono text-[11px] tracking-[0.5em] uppercase text-[#C9A24A] opacity-50 mb-7">Contact</p>
              <div className="flex flex-col gap-4">
                ...
                <a
                  ...
                  className="font-mono text-[12px] tracking-[0.1em] hover:text-[#C9A24A] transition-colors duration-300 normal-case"
                  style={{ color: "#EDEBE3" }}
                >
          ...
          <div className="flex items-center gap-6">
            {[
              ...
              <Link
                ...
                className="font-mono text-[11px] tracking-[0.3em] uppercase hover:text-[#C9A24A] transition-colors duration-300"
                style={{ color: "#EDEBE3" }}
              >
                {l.label}
              </Link>
